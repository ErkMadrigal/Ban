<?php
    ...
    $referencia1 = ( $_POST['referencia_1'] !== "") ? $_POST['referencia_1'] : null;
    $referencia2 = ( $_POST['referencia_2'] !== "") ? $_POST['referencia_2'] : null;
    $referencia3 = ( $_POST['referencia_3'] !== "") ? $_POST['referencia_3'] : null;
    $refTelefono1 = ( $_POST['referencia_1'] !== "") ? $_POST['referencia_1'] : null;
    $refTelefono2 = ( $_POST['referencia_2'] !== "") ? $_POST['referencia_2'] : null;
    $refTelefono3 = ( $_POST['referencia_3'] !== "") ? $_POST['referencia_3'] : null;
    ...
    if($claseValidar->isName($referencia1) === 0 ){
        $errores[] = "por favor ingresa un nombre valido";
    }
    if($claseValidar->isName($referencia2) === 0 ){
        $errores[] = "por favor ingresa un nombre valido";
    }
    if($claseValidar->isName($referencia3) === 0 ){
        $errores[] = "por favor ingresa un nombre valido";
    }
   ...
   /* if ( $claseValidar->isPhone( $refTelefono1 ) === 0 ) {
        $errores[] = "ingresa un numero valido";
    }
    if ( $claseValidar->isPhone( $refTelefono2 ) === 0 ) {
        $errores[] = "ingresa un numero valido";
    }
    if ( $claseValidar->isPhone( $refTelefono3 ) === 0 ) {
        $errores[] = "ingresa un numero valido";
    }*/
    ...
    if($claseValidar->diffDate($fecha) < 6570){
    ...
    if(count($errores) === 0){
        ...
        $validarUsuario = $claseConsultas->userValidate($nip , $telefono , $correo);
        $respuesta = null;
        if(!$validarUsuario){
            $respuesta = $claseInserciones->registrarUsuario($nombreUsuario, $apellido, $correo, $telefono, 1,1, $referencia1, $referencia2, $referencia3, $refTelefono1, $refTelefono2, $refTelefono3, $fecha, $genero,  $nip);
        }else{
