...
<link href="<?php echo $raiz;?>css/sb-admin-2.min.css" rel="stylesheet">

<!-- Content Wrapper -->
<div id="content-wrapper" class="d-flex flex-column" style="margin-top: 7rem;">
    ...
    <?php $diaActual = date("D"); ?>
    <?php $mesActual = date("M"); ?>
    <?php $anioActual = date("Y"); ?>

        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Univer &copy; <?php echo $diaActual."/".$mesActual."/".$anioActual; ?>
                </span>
            </div>
        </div>
    </footer>
...
<script src="<?php echo $raizBanco;?>js/bootstrap.bundle.min.js"></script>

<!-- Core plugin JavaScript-->
<script src="<?php echo $raizBanco;?>js/jquery.easing.min.js"></script>

<!-- Custom scripts for all pages-->
<script src="<?php echo $raizBanco;?>js/sb-admin-2.min.js"></script>
<!-- Page level plugins -->
<script src="<?php echo $raizBanco;?>/js/Chart.min.js"></script>

<!-- Page level custom scripts -->
<script src="<?php echo $raizBanco;?>js/chart-area-demo.js"></script>
<script src="<?php echo $raizBanco;?>js/chart-pie-demo.js"></script>
